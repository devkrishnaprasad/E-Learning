...
const Color secondaryColor = Color(0xFFD5E2F5);
...
const Color fontTitleColor = Color(0xFFFF6B00);
const Color fontResultColor = Color(0xFF0961F5);
const Color fontSecondaryColor = Color(0xFF545454);
const Color filterTextColor = Color(0xFF202244);
